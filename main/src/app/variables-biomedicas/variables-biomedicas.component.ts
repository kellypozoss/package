...
@Component({
  selector: 'app-variables-biomedicas',
  templateUrl: './variables-biomedicas.component.html',
  styleUrls: ['./variables-biomedicas.component.scss']
})
export class VariablesBiomedicasComponent implements AfterViewInit {
